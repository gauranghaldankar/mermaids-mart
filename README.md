...
42. List Orders
    ...
    2. Add reducer to store
    3. show products on the screen
43. Delete Order 2. create constant, actions and reducers for delete order 3. add order delete action to order list
44. Deliver Order
...
54. Review Products and Sellers
