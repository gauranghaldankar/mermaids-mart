...
# Mermaids Mart Pet ECommerce Website
...
46. Publish heroku
    ...
    4. `heroku login`
    5. `heroku apps:create <yourname>-mermaidsmart`
    6. Edit package.json
    ...
    21. Commit and push
    22. Open `https://<yourname>-mermaidsmart.herokuapp.com/api/users/seed`
    23. Open `https://<yourname>-mermaidsmart.herokuapp.com`
...
50. Deploy on AWS LightSail
    ...
    1. mkdir -p ~/apps/mermaidsmart/repo
    2. mkdir -p ~/apps/mermaidsmart/dest
    3. cd repo
    4. git --bare init
    5. nano hooks/post-receive
       ...
       cd ~/apps/mermaidsmart/dest/
       echo 'post-receive: git check out...'
       git --git-dir=/home/bitnami/apps/mermaidsmart/repo/ --work-tree=/home/bitnami/apps/mermaidsmart/dest/ checkout master -f
       echo 'post-receive: npm install...'
       npm install
       npm run build
       forever restart mermaidsmart
       ```
    ...
    10. forever start --uid="mermaidsmart" --sourceDir="/home/bitnami/apps/mermaidsmart/dest/" backend/server.js
    11. sudo /opt/bitnami/bncert-tool
    12. sudo nano /opt/bitnami/apache2/conf/bitnami/bitnami-ssl.conf

    ```shell
    <VirtualHost _default_:443>
      ServerName mermaidsmart.webacademy.pro
      # ...
    ...
    2.  In Lightsail UI > Network > DNS > Add A mermaidsmart subdomain
    3.  In Local computer
